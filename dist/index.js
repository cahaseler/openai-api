...
async function run() {
    try {
        ...
        const temperature = parseInt(core.getInput('temperature'), 1000);
        const max_tokens = parseInt(core.getInput('max_tokens'), 1);
        core.debug(`Getting chat completion ...`);
        const completionResponse = await (0, openai_1.getSimpleChatCompletion)(apiKey, prompt, input, model, temperature, max_tokens);
        ...
        core.setOutput('usage_prompt_tokens', completionResponse?.usage?.prompt_tokens ?? 0);
        core.setOutput('usage_completion_tokens', completionResponse?.usage?.completion_tokens ?? 0);
        core.setOutput('usage_total_tokens', completionResponse?.usage?.total_tokens ?? 0);
    }
    catch (error) {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.getSimpleChatCompletion = void 0;
 ...
 */
async function getSimpleChatCompletion(apiKey, prompt, input, model, temperature, max_tokens) {
...
exports.getSimpleChatCompletion = getSimpleChatCompletion;
...
const nf = __nccwpck_require__(467);
...
const fd = __nccwpck_require__(880);
...
const agent_1 = __nccwpck_require__(4484);
const fetch_1 = __nccwpck_require__(4899);
const uploads_1 = __nccwpck_require__(6800);
...
exports.createForm =
  ...
  exports.fileFromPath =
    void 0;
const formdata_1 = __nccwpck_require__(7744);
const getMultipartRequestOptions_1 = __nccwpck_require__(8462);
const fileFromPath_1 = __nccwpck_require__(8244);
...
const node_readable_1 = __nccwpck_require__(9104);
